...
class Node {
  ...
  getChildren() {
    if (this.children === null) {
      ...
      this.children = _.map(
        moves,
        move => {
          return new Node(this.game.clone(move), this, move, this.depth + 1, this.mcts);
        },
        this
      );
    }
  ...
  nextMove() {
    ...
    if (this.randomNode) {
      return _(this.getChildren())
        .shuffle()
        .last();
    }
    return _(this.getChildren())
      .shuffle()
      .sortBy(this.mcts.nodeSort)
      .last();
  }
}
...
export default class MCTS {
  ...
  selectMove() {
    ...
    return _(this.rootNode.getChildren())
      .sortBy('visits')
      .last().move;
  }
}
